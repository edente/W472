...
function myFunctionTest(expected, found) {
  ...
  console.assert((myFunctionTest(20, max(20, 10)))=="TEST SUCCEEDED",'Failed expected 2');
  ...
  console.log("Expected output of reverse('eden') is nede" + myFunctionTest('nede',reverse('eden')));
